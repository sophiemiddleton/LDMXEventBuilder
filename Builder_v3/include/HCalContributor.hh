// HCalContributor.h
#ifndef HCALCONTRIBUTOR_H
#define HCALCONTRIBUTOR_H
#pragma once
#include "Contributor.hh"
#include <string>

class HCalContributor : public Contributor {
public:
    HCalContributor(std::string contributor_id, std::string system_id)
